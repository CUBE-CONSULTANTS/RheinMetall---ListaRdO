		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#listardolistardo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"listardolistardo-display": {
								"semanticObject": "listardolistardo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=listardo.listardo",
									"url": sap.ui.require.toUrl("listardo/listardo")
								}
							}
						}
					}
